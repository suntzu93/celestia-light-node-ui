...
export const SignatureTable = ({ columns, data, isLoading }) => {
      ...
      <React.Fragment>
        ...
        >
          <TableCell align="left" style={{ width: "50%" }}>
            <Tooltip title={row.signature}>
              <span>
                {Data.formatSignature(row.signature)}
                <Copy
                  style={{ cursor: "pointer" }}
                  onClick={(e) => copyToClipBoard(row.signature)}
                />
              </span>
            </Tooltip>
          </TableCell>
          <TableCell align="left" style={{ width: "30%" }}>
            <Tooltip title={row.validator_address}>
              <span>
                <Link
                  target="_blank"
                  underline="hover"
                  href={Utils.validatorLink(row.validator_address)}
          ...
          <TableCell align="left" style={{ width: "20%" }}>
            <Tooltip title={row.timestamp}>
              <span>{Data.formatTimeToText(row.timestamp)}</span>
            </Tooltip>
          </TableCell>
        </TableRow>
      </React.Fragment>
