...
import { validatorLink } from "../../utils/utils";
      ...
      <React.Fragment>
        ...
        >
          <TableCell align="left" style={{ width: "40%" }}>
            <span>
              <Link
                target="_blank"
                underline="hover"
                href={Utils.validatorLink(row.address)}
          ...
          <TableCell align="left" style={{ width: "30%" }}>
            <span>{row.proposer_priority}</span>
          </TableCell>
          <TableCell align="left" style={{ width: "30%" }}>
            <span>{Data.formatNumberToDecimal(row.voting_power)}</span>
          </TableCell>
        </TableRow>
      </React.Fragment>
    );
